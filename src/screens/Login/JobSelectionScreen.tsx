...
const JobSelectionScreen = () => {
  ...
  const jobs = {
    개발: [
      '백엔드 개발자', '프론트엔드 개발자', '웹개발자', '앱개발자', '시스템엔지니어', '네트워크엔지니어',
      'DBA (데이터베이스 관리자)', '데이터엔지니어', '데이터사이언티스트', '보안엔지니어',
      '소프트웨어개발자', '게임개발자', '하드웨어개발자', '머신러닝엔지니어', '블록체인개발자', '클라우드엔지니어'
    ],
    디자인: [
      '일러스트레이터', 'UI/UX 디자이너', '웹퍼블리셔'
    ],
    기획: [
      '서비스 기획자', 'PM(프로덕트 매니저)', 'IT컨설팅', 'QA (품질 보증)'
    ],
    비즈니스: [
      '경영전략/사업기회 전문가', '마케팅/홍보 전문가', '컨설턴트 전문가'
    ]
  };
...
const styles = StyleSheet.create({
  container: { flex: 1, alignItems: 'center', paddingHorizontal: 20, paddingVertical: 40 },
  ...
  categoriesContainer: {
    width: '30%', borderRightWidth: 1, borderRightColor: 'gray', paddingRight: 20, alignItems: 'flex-start', height: '80%',
  },
  categoryButton: { paddingVertical: 10, width: '100%', alignItems: 'center', marginBottom: 10 },
